...
const TransactionModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'category': PropertySchema(
      ...
      name: r'category',
      type: IsarType.byte,
      enumMap: _TransactionModelcategoryEnumValueMap,
    ),
...
void _transactionModelSerialize(
  ...
  writer.writeBool(offsets[4], object.isAdd);
...
TransactionModel _transactionModelDeserialize(
  ...
  object.category = _TransactionModelcategoryValueEnumMap[
          reader.readByteOrNull(offsets[1])] ??
      TransactionCategory.salary;
  object.date = reader.readDateTime(offsets[2]);
  object.description = reader.readStringOrNull(offsets[3]);
  object.id = id;
  object.isAdd = reader.readBool(offsets[4]);
...
P _transactionModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_TransactionModelcategoryValueEnumMap[
              reader.readByteOrNull(offset)] ??
          TransactionCategory.salary) as P;
    case 2:
...
const _TransactionModelcategoryEnumValueMap = {
  'salary': 0,
  'food': 1,
  'transport': 2,
  'shopping': 3,
...
const _TransactionModelcategoryValueEnumMap = {
  0: TransactionCategory.salary,
  1: TransactionCategory.food,
  2: TransactionCategory.transport,
  3: TransactionCategory.shopping,
  4: TransactionCategory.bills,
  5: TransactionCategory.health,
  6: TransactionCategory.entertainment,
  7: TransactionCategory.education,
  8: TransactionCategory.other,
};
...
extension TransactionModelQueryFilter
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      categoryEqualTo(TransactionCategory value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'category',
        value: value,
...
extension TransactionModelQuerySortBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy> sortByIsAdd() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAdd', Sort.asc);
    });
  }
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy>
      sortByIsAddDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAdd', Sort.desc);
    });
  }
...
extension TransactionModelQuerySortThenBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy> thenByIsAdd() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAdd', Sort.asc);
    });
  }
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct>
      distinctByIsAdd() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isAdd');
    });
  }
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, TransactionCategory, QQueryOperations>
      categoryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, bool, QQueryOperations> isAddProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isAdd');
    });
  }
